...
-- 1 Week of Data based on Order Week and Test Partner Level

-- SELECT driver_id FROM drivers WHERE is_test = TRUE // will be using below instead of lists of id
...
-- 5. Over All Data on Week and Status Level for 10 Weeks
...
SELECT id FROM drivers WHERE is_test = TRUE ;
